      ...
      <div className="container my-5">
        ...
        <div className="AddMatchLink">
          <button
            ...
            onClick={() => navigate(`/manager-dashboard/add-group/${matchId}`)}
          >
            Add/Manage Group
          </button>
        </div>
                    ...
                    <div className="MachesActions">
                      {!group.hasBets && (
                          <button
                            ...
                            onClick={() => navigate(`/manager-dashboard/edit-group/${group._id}`)}
                          >
                            Edit
                          </button>
                      )}
                      <button
                        ...
                        onClick={() => navigate(`/manager-dashboard/view-bets/${group._id}`)}
                      >
                        View Bets
                      </button>
                      <button
                        className="btn btn-sm btn-warning me-2"
                        onClick={() => navigate(`/manager-dashboard/view-bettingsheet/${group._id}`)}
                      >
                        Betting Sheet
                      </button>
                      <button
